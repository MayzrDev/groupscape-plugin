...
public final class PatchTimerEntry {
    public final String category; // "herb" | "tree" | "birdhouse"
    ...
    public PatchTimerEntry(String category, String label, String status, Long readyAt, boolean unconfirmed) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(category, label, status, readyAt, unconfirmed);
    }
}
